...
title_div.className = "mdl-card__title"; 
text_div.className = "mdl-card__supporting-text"; 
media_div.className = "mdl-card__media"; 

var title = document.createTextNode("Bumping page please stand by..."); 
var text = document.createTextNode("While you wait... why not read some XKCD?"); 
var comic = document.createElement("img");

comic.src = "https://imgs.xkcd.com/comics/fire_ants.png"; 

title_div.appendChild(title); 

text_div.appendChild(text); 

media_div.appendChild(comic); 
